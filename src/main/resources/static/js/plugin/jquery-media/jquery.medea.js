...
window.Medea = (function($) { 
    ...
    function formobject(selector, delimiter) {
        var form = $(selector);
        if(form.length === 0) { 
            console.warn("medea.formobject: no form found at %s", selector);
            return {}; 
        }
        delimiter = delimiter || ".";
        ...
        if(formValues.length === 0) { 
            console.warn("medea.formobject: no input fields found at %s", selector);
            return {}; 
        }
        var result = {};
        var arrays = {};
    ...
    function buttons(container) { 
        ...
        $("body").on("click", "#medea-cancel-btn", function(e) { 
            ...
            var processedObject = formobject(elements.form);
    ...
    function togglerButton() { 
        return icon("refresh", function(e) { 
            var inputTypes = [ 
    ...
    **/
    ...
    function addEventHandlers(container) { 
        ...
        container.on(events.MEDEA_FIELD_ADD, function(e, obj) { 
